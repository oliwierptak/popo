...
class PopoFacadeTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->schemaDirectory = \Popo\TESTS_DIR . 'fixtures/';
    ...
    public function testDirectoriesShouldExist(): void
    {
        ...
        $this->expectExceptionMessageRegExp('/^Required schema directory does not exist under path:/');
    ...
    public function testGeneratePopo(): void
    {
        ...
        $this->assertFileNotExists(\Popo\TESTS_DIR . 'App/Generated/Popo/BuzzInterface.php');
        $this->assertFileNotExists(\Popo\TESTS_DIR . 'App/Generated/Popo/FooInterface.php');
        $this->assertFileNotExists(\Popo\TESTS_DIR . 'App/Generated/Popo/FooBarInterface.php');
    }
...
class FooGenerated 
{
  ...
  \'fooId\' => \'\',
     ...
     * @param array $data
     *
     * @return \Popo\Tests\FooGenerated
     */
