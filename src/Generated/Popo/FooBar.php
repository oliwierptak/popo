...
class FooBar 
{
  ...
  'buzzPropertyInFooBar' => 'string',
     ...
     * @param array $data
     *
     * @return \Generated\Popo\FooBar
     */
    public function fromArray(array $data): \Generated\Popo\FooBar
    {
        $result = [];
        foreach ($this->propertyMapping as $key => $type) {
     ...
     * @return self
     */
    public function setFooBarId(?int $fooBarId): \Generated\Popo\FooBar
    {
     ...
     * @return self
     */
    public function setFooBarStringValue(?string $fooBarStringValue): \Generated\Popo\FooBar
    {
     ...
     * @return self
     */
    public function setBuzzPropertyInFooBar(?string $buzzPropertyInFooBar): \Generated\Popo\FooBar
    {
